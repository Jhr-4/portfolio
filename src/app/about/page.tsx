      ...
      <main className="max-w-4xl w-full space-y-8 py-12 relative z-10">
        ...
        <section className="mb-8">
          <p className="text-lg text-foreground">
            Hey, I'm Jay Rana, a Computer Science undergraduate at NJIT, passionate about learning and solving problems through technology. I currently work as a Web Specialist and am exploring various fields like software development, web technologies, and AI.
          </p>
        </section>
          ...
          <div className="lg:w-1/2 flex flex-col justify-center">
            ...
            <div className="space-y-4 mb-10">
              ...
              <p className="text-foreground mb-4">
                This portfolio showcases my past projects and things I'm currently working on. Some <a href="/projects">past projects</a> include: <strong>StellarNews</strong> a platform to get all space news in one place, a <strong>gradebook style calculator</strong>, and an <strong>CMS project</strong>. Additionally, there's an AI Playground page with integrated projects created by experimenting with autocoder tools (e.g., GitHub Copilot Agents, Windsurf) to build skills like prompt engineering and learn to integrate AI (like <a href="/playground/rag-chat"> RAG applications</a>) into practical projects.
              </p>
            </div>
